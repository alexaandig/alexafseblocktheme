                    ...
                    <div class="lemmony-dash-childs">
                        ...
                        <div class="lemmony-dash-child__item">
                            <div class="lemmony-dash-child__image">
                                <img src="<?php echo esc_attr( get_template_directory_uri() . '/assets/media/dashboard-child1.png' ); ?>" alt="<?php esc_attr_e( 'Lemmony Agency (soon)', 'lemmony' ); ?>" />
                            </div>
                            <div>
                                <h3>
                                    <?php esc_html_e( 'Lemmony Agency (soon)', 'lemmony' ); ?>
                                </h3>
                                <p>
                                    <?php esc_html_e( 'This is Lemmony child demo', 'lemmony' ); ?>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="lemmony-dash-child__item">
                            <div class="lemmony-dash-child__image">
                                <img src="<?php echo esc_attr( get_template_directory_uri() . '/assets/media/dashboard-child2.png' ); ?>" alt="<?php esc_attr_e( 'Lemmony Magazine (soon)', 'lemmony' ); ?>" />
                            </div>
                            <div>
                                <h3>
                                    <?php esc_html_e( 'Lemmony Magazine (soon)', 'lemmony' ); ?>
                                </h3>
                                <p>
                                    <?php esc_html_e( 'This is Lemmony child demo', 'lemmony' ); ?>
                                </p>
