<?php
/**
 * Title: 3 Column Pricing Table
 * Slug: 3-column-pricing-table
 * Categories: pricing
 */
?>
...
<hr class="wp-block-separator has-text-color has-css-opacity has-background is-style-wide has-background" style="background-color:#000000;color:#000000"/>
<!-- /wp:separator -->
