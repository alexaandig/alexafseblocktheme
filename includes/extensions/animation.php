...
add_filter( 'alexa_editor_data', NS . 'add_animation_names' );
/**
...
add_filter( 'alexa_inline_js', NS . 'add_animation_js', 10, 2 );
/**
...
add_filter( 'alexa_inline_js', NS . 'add_scroll_js', 10, 2 );
/**
