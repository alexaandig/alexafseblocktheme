...
function add_editor_scripts_hook( WP_Screen $screen ): void {
	...
	add_action(
		...
		static fn() => do_action( 'alexa_editor_scripts', $screen )
	);
}

add_action( 'alexa_editor_scripts', NS . 'enqueue_editor_scripts' );
/**
...
function get_editor_data() {
	...
	return apply_filters(
		...
		[
			...
			'nonce'         => wp_create_nonce( 'alexa' ),
			'icon'          => get_icon( 'social', 'alexa' ),
