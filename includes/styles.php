...
add_action( 'alexafse_editor_scripts', NS . 'enqueue_editor_only_styles' );
/**
...
function add_editor_stylesheets() {
	...
	add_editor_style( 'https://alexafse-dynamic-styles' );
}
...
function generate_dynamic_styles( $response, array $parsed_args, string $url ) {
	if ( $url === 'https://alexafse-dynamic-styles' ) {
		$response = [
...
add_filter( 'alexafse_inline_css', NS . 'add_child_theme_style_css' );
/**
